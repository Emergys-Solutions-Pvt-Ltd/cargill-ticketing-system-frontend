...
import { assignGroupToUser, removeGroupsFromUser, getUserDetails, editUser } from "../../../../api/apiRequests";
        ...
        <ConfirmDialog
          ...
          onConfirm={() => {
            ...
            removeGroupsFromUser({
              userId: Number(user.id),
              groupIds: [Number(removeTarget.id)],
            })
              .then(() => {
              ...
              .catch(() => {})
              .finally(() => setRemoveGroupLoading(false));
          }}
